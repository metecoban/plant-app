...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoriesResponseModel&&const DeepCollectionEquality().equals(other.data, data));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<PlantModel> data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoriesResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<PlantModel> data)  $default,) {final _that = this;
switch (_that) {
case _CategoriesResponseModel():
return $default(_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<PlantModel> data)?  $default,) {final _that = this;
switch (_that) {
case _CategoriesResponseModel() when $default != null:
return $default(_that.data);case _:
  return null;
...
class _CategoriesResponseModel implements CategoriesResponseModel {
  const _CategoriesResponseModel({required  List<PlantModel> data}): _data = data;
  factory _CategoriesResponseModel.fromJson(Map<String, dynamic> json) => _$CategoriesResponseModelFromJson(json);

 final  List<PlantModel> _data;
@override List<PlantModel> get data {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CategoriesResponseModel&&const DeepCollectionEquality().equals(other._data, _data));
}
